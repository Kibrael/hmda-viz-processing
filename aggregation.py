...
class aggregate(object): #aggregates LAR rows by appropriate characteristics to fill the JSON files
	...
	def __init__(self):
		...
		self.table_B_rates = self.create_rate_lists(2) #lists by property type. 0 = single family, 1 = manufactured, 2 = multifamily
	...
	def fill_rates_B(self, inputs):
		...
		if inputs['rate spread'] != 'NA   ' and inputs['rate spread'] != '     ' and property_type < 2:
